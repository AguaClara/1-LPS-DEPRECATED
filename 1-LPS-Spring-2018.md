...
<div class="alert alert-block alert-danger">
This is a great figure, but consider labeling what the CDC and the entrance tank are. - unresolved
</div>
...
<div class="alert alert-block alert-danger">
Consider referring the reader to Monroe's 4540 slides for a deeper explanation
</div>
...
<div class="alert alert-block alert-danger">
Slightly repetitive, consider slimming down
</div>
...
<div class="alert alert-block alert-danger">
Seeing this figure makes me want you all to include a picture of the whole apparatus in the intro to give the reader some more insight. Also reference past reports in the intro for info about the other parts of the plant.
</div>
...
<div class="alert alert-block alert-danger">
What are the main things that you are testing the EstaRS for?

consider a photo of the EStaRS filter
</div>
