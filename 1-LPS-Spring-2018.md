...
Consider including a schematic to show how these relate here so that readers can directly associate your description and problem with the physical pieces.
</div>
...
Is the old design the one made in Spring 2017? Ambiguous

Why did you make this change? The "why" of your decisions is the most important aspect? How does the slimmer pipes affect the dosing?
</div>
...
<div class="alert alert-block alert-danger">
Why does the height of the lever arm need to be the height of coagulant level of the CDC when the float valves are submerged?

How will you match the heights?

Starting a sentence with "because" is too informal for the research report.

Why does this fix going to occur after assembling all the materials needed for a coagulant run? What else do you need?
</div>
...
<div class="alert alert-block alert-danger">
This is a great figure, but consider labeling what the CDC and the entrance tank are.
</div>
